...
INSERT INTO "Application" ("ApplicationID", "ApplicationName", "ApplicationEnabled") VALUES
    ...
    (4, 'Devices.Client.Solutions Scheduled Job (Weather [B1])', TRUE),
    (5, 'Devices.Client.Solutions Scheduled Job (Weather [B7])', TRUE),
...
INSERT INTO "Action" ("ActionID", "ActionType", "ActionParameters", "ActionArguments") VALUES
    ...
    (4, 1, 'Install.sh', 'SetupScheduledJobs "Devices.Client.Solutions.Weather-B1"'),
	(5, 1, 'Install.sh', 'SetupScheduledJobs "Devices.Client.Solutions.Weather-B7"'),
	(6, 1, 'Install.sh', 'SetupScheduledJobs "Devices.Client.Solutions.Watering"'),
	(7, 1, 'Install.sh', 'SetupScheduledJobs "Devices.Client.Solutions.Camera-B1"'),
    (8, 1, 'Install.sh', 'SystemUpdate'),
    (9, 1, 'Install.sh', 'SystemRestart'),
